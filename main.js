...
day_night.addEventListener('click', ()=>{
    ...
    document.documentElement.style.setProperty('--color-5', 'rgb(0,0,0,.5)');
    document.documentElement.style.setProperty('--color-4', '#663da6');
...
let audio1 = new Audio("audio/robot.mp3");
// audio.play();
